...
echo "python automate/automate-git.py --force-clean --arm-build --download-dir=chromium_git --depot-tools-dir=depot_tools --no-distrib --build-target=cefsimple --branch=3729" >> ~/code/chromium_git/update.sh
...
export cef_pack=cef_binary_3.3729.108.g1234567_linuxarm_client
mkdir ~/code/$cef_pack
